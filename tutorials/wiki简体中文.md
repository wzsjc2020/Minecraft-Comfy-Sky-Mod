...
特性：1.可以在上面种植原版作物和花，不包括西瓜藤和南瓜藤，v17.0.4添加的露水花也可以种植在上面。		   2.使用任意等级的**挖掘铲**挖掘草方块分别有1/20的概率获得碎铁矿，碎煤，碎石。
...
获取此物品的方法：使用任意等级的**挖掘铲**左键草方块，有1/20的概率获得
