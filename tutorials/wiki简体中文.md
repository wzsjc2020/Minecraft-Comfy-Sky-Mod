...
​			3.可以放置在花盆中，同时火焰花盆栽也可以发出12格光照强度
...
![](img/dew_bottle-32px.png)![](img/packing_tape-32px.png)![](img/packed_barrel-32px.png)![](img/driftwood-32px.png)![](img/drift_bamboo-32px.png)![](img/electrostatic_discharge_rod-32px.png)![](img/wall_calender_sign-32px.png)![](img/fish_trap-32px.png)
...
基础数据：@nbt Day @nbt Text1-4 @nbt glow @nbt dye #axe @waterlogable
...
​			开发者注释：晚上这段时间是摆放生命花的好时机，所以生命花会自带光源

获取此物品的方法：工作台合成 或 使用精准采集的工具
...
生命花是一种赛博花，它虽然叫做生命花，但是其实完全是受控于算法的非生命体，所以它并没有原版花的任何特性（不能作为肥料堆肥，不能合成花种子，不能吸引蜜蜂，等...）
