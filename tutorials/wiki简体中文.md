...
​			3.挖掘过的土地带有moisture属性时，方块状态改变为最大湿度

获取此物品的方法：工作台合成

简单解释如何使用此物品：左键挖掘方块，详见特性-挖掘铲可挖掘的方块。如果这个方块带有moisture的属性，在挖掘时将方块状态改变为最大湿度
...
| 方块名 | id                    | 挖掘等级      | 添加版本 | 掉落物                                                       |
| ------ | --------------------- | ------------- | -------- | ------------------------------------------------------------ |
| 红沙   | minecraft:red_sand    | Material.WOOD | v17.0.1  | ![](img/crushed_gold_ore-32px.png)                           |
| 草方块 | minecraft:grass_block | Material.WOOD | v17.0.6  | ![](img/crushed_iron_ore-32px.png)![](img/crushed_stone-32px.png)![](img/crushed_coal-32px.png) |
|        |                       |               |          |                                                              |
