...
基础数据：@light level:15  #broke instantly

特性：1.可以发出15格光照强度

​			2.火焰花可以制作谜之炖菜，食用后产生发光效果，时长4秒

​			5.可以放置在花盆中，同时火焰花盆栽也可以发出15格光照强度

获取此物品的方法：在被挖掘的方块上种植花种子，有概率种出火焰花

简单解释如何使用此物品：右键放置在耕地或标签为treasurehuntlib:farmland的方块上
...
基础数据：RANGE=0 #digging_shovel @Material.WOOD
...
简单解释如何使用此物品：左键一个可以被挖掘的方块，将其转换成被挖掘的方块
...
基础数据：RANGE=1 #digging_shovel @Material.STONE
...
简单解释如何使用此物品：左键一个可以被挖掘的方块，将其转换成被挖掘的方块，如果这个方块带有moisture的属性，则在转换时将转换的方块设置moisture的最大值
