...
加载此模组会自动替换Minecraft流浪商人生成算法。（添加于v17.0.9）

![](C:\Users\22919\Desktop\fabric\comfysky\tutorials\screenshot\wandering.png)

（图：ComfySky 修改后的流浪商人生成几率）

原版流浪商人每24000tick有25%，50%，75% * 10%生成几率（即最大生成可能性为7.5%每24000tick）

修改后在原有的25%，50%，75%生成几率不改变的情况下，额外增加4级生成

| 等级 | 概率               | 最大生成概率 | 生成流浪商人数量（每24000tick） |
| ---- | ------------------ | ------------ | ------------------------------- |
| 0    | 25%,50%,75%        | 不适用       | 0                               |
| 1    | 25%,50%,75% * 100% | 75%          | 1（保底）                       |
| 2    | 25%,50%,75% * 10%  | 7.5%         | 2                               |
| 3    | 25%,50%,75% * 1%   | 0.75%        | 4                               |
